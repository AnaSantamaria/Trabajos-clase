...
class TestNotasService {
	static	NotasService service= new NotasService(); //objeto, es estatic porque trabaja con metodos static
	...
	@Test
	void testMedia() {
		//hacemos suposiciones con metodos assert
	...
	void testObtenerNotas() {
		...
		//assertArrayEquals(new Double [] {5.0,8.0,1.0,6.0)/
